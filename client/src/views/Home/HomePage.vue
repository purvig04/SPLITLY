      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card h-100 shadow-sm hover-card" @click="goToGroups">
            <div class="card-body text-center py-5">
              <img
                src="https://img.icons8.com/color/80/group.png"
                alt="Groups"
                class="mb-3"
              />
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card h-100 shadow-sm hover-card" @click="goToGeneral">
            <div class="card-body text-center py-5">
              <img
                src="https://img.icons8.com/color/80/receipt.png"
                alt="General"
                class="mb-3"
              />
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card h-100 shadow-sm hover-card" @click="goToAnalysis">
            <div class="card-body text-center py-5">
              <img
                src="https://img.icons8.com/color/80/combo-chart.png"
                alt="Analysis"
                class="mb-3"
              />
              <h5 class="card-title">Analysis</h5>
              <p class="card-text">Visualize your expenses with charts.</p>
            </div>
          </div>
        </div> -->
      </div>
